CREATE DATABASE  IF NOT EXISTS `recetas` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `recetas`;
...
CREATE TABLE `likes` (
  ...
  CONSTRAINT `fk_likes_recipes1` FOREIGN KEY (`recipes_id`) REFERENCES `recipes` (`id`),
...
CREATE TABLE `recipes` (
  ...
  `date_cooked_at` date DEFAULT NULL,
...
-- Dump completed on 2022-07-15 16:25:27
